...
DROP POLICY IF EXISTS "Chat participants can see reactions" ON public.chat_reactions;
...
DROP POLICY IF EXISTS "Authenticated can add reactions" ON public.chat_reactions;
...
DROP POLICY IF EXISTS "Receiver can reply to their messages" ON public.message_replies;
...
DROP POLICY IF EXISTS "Sender can see replies" ON public.message_replies;
...
DROP POLICY IF EXISTS "Users can see own blocks" ON public.blocked_users;
CREATE POLICY "Users can see own blocks" ON public.blocked_users FOR SELECT USING (auth.uid() = blocker_id);
DROP POLICY IF EXISTS "Authenticated can block" ON public.blocked_users;
...
DROP POLICY IF EXISTS "Anyone can record visits" ON public.profile_visits;
CREATE POLICY "Anyone can record visits" ON public.profile_visits FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Profile owners can see visits" ON public.profile_visits;
