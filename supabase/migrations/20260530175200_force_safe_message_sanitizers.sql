-- Force-replace both old and new sanitizer functions without ever constructing chr(0).
-- Keeping the old function name fixes databases where existing triggers are still bound to it.
